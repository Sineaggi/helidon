...
public class HelidonHK2InjectionManagerFactory extends Hk2InjectionManagerFactory {
    ...
    public InjectionManager create(Object parent) {
        ...
        if (parent == null) {
            ...
            LOGGER.log(System.Logger.Level.TRACE, () -> "Creating injection manager " + result);
        } else if (parent instanceof ImmediateHk2InjectionManager) {        // single JAX-RS app
            result = (InjectionManager) parent;
            LOGGER.log(System.Logger.Level.TRACE, () -> "Using injection manager for single app case " + result);
            ...
            LOGGER.log(System.Logger.Level.TRACE, () -> "Creating injection manager for multi app case " + forApplication
                    + " with shared " + wrapper.injectionManager);
        } else if (parent instanceof HelidonInjectionManager) {
            result = (InjectionManager) parent;
            LOGGER.log(System.Logger.Level.TRACE, () -> "Re-using existing Helidon injection manager " + result);
        } else {
    ...
    static class HelidonInjectionManager implements InjectionManager {
        ...
        public void register(Binding binding) {
            if (returnedByApplication(binding)) {
                ...
                LOGGER.log(System.Logger.Level.TRACE, () -> "register forApplication " + forApplication + " " + toString(binding));
            } else {
                shared.register(binding);
                LOGGER.log(System.Logger.Level.TRACE, () -> "register shared " + shared + " " + toString(binding));
            }
        }
        ...
        public void register(Object provider) throws IllegalArgumentException {
            if (getSingletons().contains(provider)) {
                ...
                LOGGER.log(System.Logger.Level.TRACE, () -> "register forApplication " + forApplication + " " + provider);
            } else {
                shared.register(provider);
                LOGGER.log(System.Logger.Level.TRACE, () -> "register shared " + forApplication + " " + provider);
            }
        }
        ...
        public <T> List<ServiceHolder<T>> getAllServiceHolders(Class<T> contractOrImpl, Annotation... qualifiers) {
            ...
            sharedList.forEach(sh -> LOGGER.log(System.Logger.Level.TRACE, () ->
            ...
            forApplicationList.forEach(sh -> LOGGER.log(System.Logger.Level.TRACE, () ->
