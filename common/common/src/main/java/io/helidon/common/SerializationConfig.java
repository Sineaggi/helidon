...
public final class SerializationConfig {
    ...
    private void doConfigure() {
        ...
        if (currentFilter == null) {
            ...
            case WARN:
                ...
                configureTracingFilter(options, it -> {
                    if (it.serialClass() != null && logged.compareAndSet(false, true)) {
                        LOGGER.log(System.Logger.Level.WARNING, "Deserialization attempted for class " + it.serialClass().getName()
                ...
                return;
            case IGNORE:
                LOGGER.log(System.Logger.Level.TRACE, "Ignoring that there is no global serial filter configured. To automatically configure"
                                      + " a filter, please set system property " + PROP_NO_CONFIG_ACTION
                                      + " to \"configure\"");
            ...
            if (action == Action.IGNORE) {
                LOGGER.log(System.Logger.Level.TRACE, "Existing serialization config is ignored by Helidon.");
                return;
            }
    ...
    private void validateExistingFilter(ObjectInputFilter currentFilter, Action action) {
        ...
        if (currentFilterString == null) {
            LOGGER.log(System.Logger.Level.TRACE, "Programmatic filter configured: " + currentFilter);
            ...
            LOGGER.log(System.Logger.Level.TRACE, "System property filter configured: " + currentFilterString);
    ...
    private void handleBadFilter(Action action, String message) {
        ...
        case IGNORE:
            LOGGER.log(System.Logger.Level.TRACE, "Ignoring global deserialization filter issue. Original message: " + message);
            break;
        default:
    ...
    private void configureGlobalFilter(ConfigOptions options) {
        ...
        LOGGER.log(System.Logger.Level.TRACE, "Using serialization pattern " + pattern);
    ...
    public static class Builder implements io.helidon.common.Builder<Builder, SerializationConfig> {
        ...
        private static Action configuredAction(String sysProp, Action defaultValue) {
            ...
            try {
                ...
                LOGGER.log(System.Logger.Level.WARNING, "System property \"" + sysProp + "\" is configured to \"" + property + "\", which is"
        ...
        private static TraceOption configuredTrace(TraceOption defaultValue) {
            ...
            try {
                ...
                LOGGER.log(System.Logger.Level.WARNING, "System property \"" + PROP_TRACE + "\" is configured to \"" + property + "\", which is"
        ...
        private String getPattern() {
            ...
            try {
                ...
                while (resources.hasMoreElements()) {
                    ...
                    if (pattern == null) {
                        LOGGER.log(System.Logger.Level.WARNING, "Could not find 'pattern' property in " + url);
                    } else {
                        if (!pattern.isBlank()) {
                            parts.add(pattern);
                        }
