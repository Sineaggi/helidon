...
public final class ThreadPoolSupplier implements Supplier<ExecutorService> {
    ...
    ExecutorService getThreadPool() {
        if (useVirtualThreads) {
            if (VirtualExecutorUtil.isVirtualSupported()) {
                LOGGER.log(Level.DEBUG, "Using unbounded virtual executor service for pool " + name);
    ...
    public static final class Builder implements io.helidon.common.Builder<Builder, ThreadPoolSupplier> {
        ...
        private void warnExperimental(String key) {
            LOGGER.log(System.Logger.Level.WARNING, String.format("Config key \"executor-service.%s\" is EXPERIMENTAL and subject to change.", key));
        }
